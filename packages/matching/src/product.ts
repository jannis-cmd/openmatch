...
type FixtureSeed = Pick<
  ...
  | "lifestyle"
  | "color"
> & { focus: string; preference?: Partial<Preferences> };

const additionalFixtureSeeds: FixtureSeed[] = [
  {
    id: "amina",
    name: "Amina",
    age: 27,
    ...
    lifestyle: { smoking: "no", children: "want", schedule: "flexible" },
    color: "#CDA99A",
    focus: "community cooking and learning languages",
  },
  {
    id: "jonas",
    name: "Jonas",
    ...
    values: ["Adventure", "Humor", "Independence"],
    lifestyle: { smoking: "sometimes", children: "open", schedule: "late" },
    color: "#9EB8C0",
    focus: "trail running and tiny live-music venues",
    preference: { smoking: "any" },
  },
  {
    id: "elena",
    name: "Elena",
    ...
    intent: "Long-term relationship",
    readiness: "Ready to meet in person",
    values: ["Stability", "Care", "Creativity"],
    lifestyle: { smoking: "no", children: "open", schedule: "early" },
    color: "#C9A8B6",
    focus: "restoring furniture and Sunday newspapers",
    preference: { ageMin: 36, ageMax: 48, maximumDistanceKm: 90 },
  },
  {
    id: "kai",
    name: "Kai",
    ...
    pronouns: "they/them",
    gender: "Genderfluid",
    genderIdentities: ["genderfluid"],
    genderSelfDescription: "",
    genderGroups: ["nonbinary_people"],
    intent: "Still figuring it out",
    readiness: "Prefer to chat first",
    values: ["Creativity", "Community", "Humor"],
    lifestyle: { smoking: "no", children: "do not want", schedule: "late" },
    color: "#AFA5C8",
    focus: "illustration, zines, and midnight cinema",
    preference: {
      ageMin: 23,
      ageMax: 34,
      intents: ["Still figuring it out", "Long-term, open to short"],
  ...
  },
  {
    ...
    intent: "Long-term relationship",
    readiness: "Ready to meet in person",
    values: ["Nature", "Family", "Kindness"],
    lifestyle: { smoking: "no", children: "want", schedule: "early" },
    color: "#B8C39D",
    focus: "lake swims and ambitious picnic baskets",
    preference: { ageMin: 31, ageMax: 43, children: "want" },
  },
  {
    id: "lucas",
    name: "Lucas",
    ...
    intent: "Long-term relationship",
    readiness: "Prefer to chat first",
    values: ["Curiosity", "Stability", "Care"],
    lifestyle: { smoking: "no", children: "open", schedule: "flexible" },
    color: "#9DB5B0",
    focus: "history podcasts and cooking without recipes",
    preference: { ageMin: 33, ageMax: 45, maximumDistanceKm: 65 },
  },
  {
    id: "nina",
    name: "Nina",
    ...
    intent: "Still figuring it out",
    readiness: "Prefer to chat first",
    values: ["Growth", "Adventure", "Community"],
    lifestyle: { smoking: "sometimes", children: "open", schedule: "late" },
    color: "#D3B58E",
    focus: "student radio and spontaneous train trips",
    preference: {
      ageMin: 22,
      ageMax: 31,
      intents: ["Still figuring it out", "Long-term, open to short"],
  ...
  },
  {
    ...
    lifestyle: { smoking: "no", children: "open", schedule: "early" },
    color: "#A9A891",
    focus: "woodworking and being the reliable dinner host",
    preference: { ageMin: 38, ageMax: 52, maximumDistanceKm: 75 },
  },
  {
    id: "imani",
    name: "Imani",
    ...
    genderIdentities: ["woman", "nonbinary"],
    genderSelfDescription: "",
    genderGroups: ["women", "nonbinary_people"],
    intent: "Long-term, open to short",
    readiness: "Ready to meet in person",
    values: ["Community", "Creativity", "Care"],
    lifestyle: { smoking: "no", children: "open", schedule: "flexible" },
    color: "#B89CB5",
    focus: "dance, design, and neighborhood projects",
  },
  {
    id: "theo",
    name: "Theo",
    ...
    pronouns: "he/they",
    gender: "Man",
    genderIdentities: ["man", "questioning"],
    genderSelfDescription: "",
    genderGroups: ["men"],
    intent: "Long-term, open to short",
    readiness: "Prefer to chat first",
    values: ["Curiosity", "Humor", "Growth"],
    lifestyle: { smoking: "no", children: "open", schedule: "late" },
    color: "#A4B7C5",
    focus: "board games and trying one new recipe a week",
    preference: { ageMin: 25, ageMax: 36 },
  },
  {
    id: "rowan",
    name: "Rowan",
    ...
    pronouns: "they/them",
    gender: "Agender",
    genderIdentities: ["agender"],
    genderSelfDescription: "",
    genderGroups: ["nonbinary_people"],
    intent: "Long-term relationship",
    readiness: "Ready to meet in person",
    values: ["Nature", "Independence", "Kindness"],
    lifestyle: { smoking: "no", children: "do not want", schedule: "flexible" },
    color: "#9FB7A5",
    focus: "birdwatching and fixing old bicycles",
    preference: { ageMin: 28, ageMax: 40, children: "do not want" },
  },
  {
    id: "fatima",
    name: "Fatima",
    ...
    lifestyle: { smoking: "no", children: "want", schedule: "early" },
    color: "#CAA88F",
    focus: "public health, poetry, and long family lunches",
    preference: {
      ageMin: 34,
      ageMax: 45,
      children: "want",
  ...
  },
  {
    ...
    lifestyle: { smoking: "no", children: "open", schedule: "late" },
    color: "#B4A4C0",
    focus: "photography and finding quiet city corners",
  },
  {
    id: "maya",
    name: "Maya",
    ...
    intent: "Long-term relationship",
    readiness: "Ready to meet in person",
    values: ["Growth", "Nature", "Stability"],
    lifestyle: { smoking: "no", children: "want", schedule: "flexible" },
    color: "#B5C2A2",
    focus: "mountain mornings and patient conversation",
    preference: { ageMin: 32, ageMax: 43, children: "want" },
  },
  {
    id: "emil",
    name: "Emil",
    ...
    intent: "Long-term, open to short",
    readiness: "Ready to meet in person",
    values: ["Humor", "Independence", "Creativity"],
    lifestyle: {
      smoking: "sometimes",
      children: "do not want",
      schedule: "late",
    ...
    color: "#9CA9B6",
    focus: "jazz records and architectural walks",
    preference: {
      ageMin: 35,
      ageMax: 49,
      smoking: "any",
      children: "do not want",
      maximumDistanceKm: 90,
    },
  },
  {
    id: "zoe",
    ...
    pronouns: "she/they",
    gender: "Woman",
    genderIdentities: ["woman", "genderfluid"],
    genderSelfDescription: "",
    genderGroups: ["women", "nonbinary_people"],
    intent: "Still figuring it out",
    readiness: "Prefer to chat first",
    values: ["Curiosity", "Adventure", "Kindness"],
    lifestyle: { smoking: "no", children: "open", schedule: "flexible" },
    color: "#C5A6B4",
    focus: "science museums and swimming in every season",
    preference: {
      ageMin: 26,
      ageMax: 38,
      intents: ["Still figuring it out", "Long-term, open to short"],
...
export const demoCandidates: Candidate[] = [
  ...
  ...additionalFixtureSeeds.map(
    ({ focus, preference, ...profile }): Candidate => ({
      profile: {
        ...profile,
        bio: `Fictional test profile interested in ${focus}.`,
        prompt: "I’m currently excited about",
        promptAnswer: focus[0].toUpperCase() + focus.slice(1) + ".",
        photo: null,
      },
      preferences: candidatePreferences({
        ageMin: Math.max(18, profile.age - 7),
        ageMax: Math.min(120, profile.age + 8),
