...
Finish the account lifecycle: verified contact ownership, privacy-preserving recovery, a transactional production datastore/migrations, endpoint-specific abuse controls, and independent security review. Validate active-session management and the new non-production account-to-account flow in threat modeling and accessibility testing. Design privacy-reviewed coarse-region identifiers instead of relying on exact free-text equality, and test reciprocal opportunity before any pilot. Do not add photos, notifications, or broader matching fields until privacy, inclusion, and safety requirements for those features are resolved.
