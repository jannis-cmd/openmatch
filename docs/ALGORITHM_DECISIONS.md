...
| Finite batches with explicit exploration | Hypothesis | Choice-overload/rejection evidence plus need to prevent feedback loops | Experiments on useful introductions, safety, wellbeing, and equitable opportunity |
